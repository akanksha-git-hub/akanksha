    ...
    >
      ...
      <div className="flex flex-col xl:flex-row bg-[#ECF0F1] rounded-lg p-16 mt-8 xl:h-[600px]">
        ...
        <div className=" flex-1  flex flex-col xl:items-end justify-start mt-4 xl:mt-0">
          <div className="bg-[#FBDA1D] w-full h-[80px] md:h-[140px] flex items-center justify-around rounded-full md:w-[60%] transition-all md:hover:h-[260px] md:group-hover:py-6 hover:h-[160px] hover:flex-col group">
            {/* Text */}
            <p className=" md:text-xl lg:text-3xl font-ambit-regular group-hover:translate-y-[-1px] md:group-hover:text-3xl group-hover:mb-2">
            ...
            <div className="relative flex items-center justify-center space-x-3">
              <div className="flex items-center">
                <p className="text-xl lg:text-3xl font-ambit-regular md:group-hover:text-8xl group-hover:text-5xl group-hover:font-ambit-semibold group-hover:-mt-8   md:group-hover:-mt-2 inline-flex">
        ...
        <div className="flex-1 w-full h-[300px] lg:h-[600px] bg-white  flex flex-col justify-between p-4">
          <div>
            ...
            <div className="flex flex-col mt-4">
              <div className="border border-black border-dashed w-[80%] xl:w-[60%] transition-all duration-300 hover:border-solid hover:bg-[#FBDA1D] hover:w-full">
