  ...
  return (
   <section
      ...
      <div className="w-full flex flex-col">
        <h1 className="font-ambit-regular text-black text-2xl text-left w-[12ch]">
          {slice.primary.card_1_description}
        </h1>
      </div>

      {/* Chart Section */}
      <div className="w-full flex flex-row mt-6 space-x-2 justify-center items-end h-[250px] mx-auto">
  {/* First Chart */}
  <div className="flex flex-col items-center justify-end w-full h-full relative max-w-[250px]">
    <span className="text-5xl font-ambit-regular text-black mb-2">{slice.primary.percentage_1}</span>
    <div className="w-full bg-[#58BCD4]  relative flex items-end justify-center p-4" style={{ height: "40%" }}>
      <span className="text-3xl font-ambit-regular text-black absolute">{slice.primary.chart_description_1}</span>
    </div>
  </div>

  {/* Second Chart */}
  <div className="flex flex-col items-center justify-end w-full h-full relative max-w-[250px]">
    <span className="text-5xl font-ambit-regular text-black mb-2">{slice.primary.percentage_2}</span>
    <div className="w-full bg-[#F4456E]  relative flex items-end justify-center p-4 " style={{ height: "80%" }}>
      <span className="text-3xl font-ambit-regular text-black absolute">{slice.primary.chart_description_2}</span>
    </div>
  </div>
</div>
    ...
    <div className="flex flex-col lg:flex-row  lg:mt-0 mt-6 lg:w-[60%] w-full relative ">
      ...
      <div className="w-full lg:w-[50%] flex flex-col justify-around items-left  space-y-4 p-6 ">
        {/* Title */}
        <h1 className="font-ambit-regular text-left text-black text-4xl md:text-7xl">
        ...
        {/* Description */}
        <p className="font-ambit-regular text-lg md:text-xl text-black text-left">
