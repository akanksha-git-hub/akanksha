...
const TiltedCards = ({ slice }) => {
  ...
  let cardAClassName =
    "1000pixel:absolute 1000pixel:-top-12 1000pixel:-left-[320px] xl:-left-[400px] 1000pixel:rotate-[-6deg]";
  let cardBClassName = "1000pixel:rotate-[4deg]";
  let cardCClassName =
    "1000pixel:absolute 1000pixel:-top-12 1000pixel:-right-[320px] xl:-right-[400px] 1000pixel:rotate-[-6deg]";
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center mt-12">
        ...
        {variationC && (
          <Button className="mt-16" prismicLink={slice.primary.cta_link}>
