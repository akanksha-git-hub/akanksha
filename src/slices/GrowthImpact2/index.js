      ...
      <div className="flex lg:flex-row flex-col lg:space-x-6  min-h-[400px]">
        <div className="flex flex-col  bg-[#ECF0F1] rounded-lg p-8 items-center justify-end  lg:w-[40%] w-full relative">
          <div className="w-[100%]  flex flex-col mt-10">
            ...
            <p className="font-ambit-regular text-lg  lg:text-3xl w-[20ch] ">
        ...
        <div className="flex flex-col md:flex-row bg-[#ECF0F1] rounded-lg p-8 lg:mt-0 mt-6 lg:w-[60%]  w-full relative">
          ...
          <div className="w-full md:w-[70%]  flex flex-col items-left justify-between ">
            <h1 className="font-ambit-regular text-black text-5xl xl:text-7xl">
          ...
          <div className="w-full md:w-[30%] h-full flex flex-col items-right justify-center">
            {/* First Box */}
            <div className="w-full bg-[#FBDA1D] mt-6 md:mt-0 text-black text-center md:py-10 py-6 px-3  flex flex-col items-center justify-center rounded-full">
            ...
            {/* Second Box */}
            <div className="w-full bg-[#F4456E] text-black text-center md:py-10 py-6 px-3 flex flex-col items-center justify-center rounded-full">
