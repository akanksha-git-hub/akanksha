...
const GrowthImpact4 = ({ slice }) => {
  return (
   <section
          ...
          >
            ...
            <div className="flex flex-col bg-[#ECF0F1] rounded-lg md:px-12  pt-10 px-6 items-center justify-between  lg:w-[50%] w-full relative overflow-hidden">
         {/* Description */}
  ...
  <div className="absolute right-0 -top-28 lg:-top-44 lg:right-12 p-2">
    <PrismicNextImage 
      field={slice.primary.card_2_asset}
      className="lg:min-w-[350px] lg:min-h-[300px] max-w-[200px] max-h-[220px] object-cover"
      alt="Card Image"
    />
  </div>
