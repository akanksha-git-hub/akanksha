...
const InitiativeShowcase = ({ slice }) => {
  ...
  let imageClassName = "relative h-[7rem] w-[7rem] sm:h-[10rem] sm:w-[10rem] lg:h-[16rem] lg:w-[16rem] 2xl:h-[20rem] 2xl:w-[20rem] 3xl:h-[25.3rem] 3xl:w-[25.3rem]";
  ...
  return (
    ...
    >
      ...
      />
      <div 
        className="mt-12 flex flex-col xl:flex-row items-center justify-between"
      >
        {/* Left Content */}
