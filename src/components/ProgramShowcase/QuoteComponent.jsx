...
export default function QuoteComponent({ quote, quote_by, storyLink }) {
  return (
    <div className="rounded-lg rounded-tr-lg rounded-br-lg md:rounded-bl-none md:rounded-tl-none bg-[#58BCD4] p-8 w-full xl:w-[56%] flex flex-col items-start justify-between">
      <div className="mt-14">
        <RichText
