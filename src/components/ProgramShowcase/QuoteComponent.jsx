...
export default function QuoteComponent({ quote, quote_by, storyLink }) {
  return (
    <div className="relative  rounded-lg rounded-tr-lg rounded-br-lg md:rounded-bl-none md:rounded-tl-none bg-[#58BCD4] p-4 w-full xl:w-[56%] flex flex-col items-start justify-between  md:min-h-[300px]">
