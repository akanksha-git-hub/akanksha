...
export default function ImageSwiper({ data }) {
  ...
  return (
    <div
      ...
      className="card-swiper relative scale-95 transition-all hover:scale-100 cursor-pointer h-[74vw] sm:h-[60vw] lg:h-[38vw]"
    >
      <div className={`card-swiper-A h-[100%] w-[60%] ${imageAClassName}`}>
        <div className={`${imageClassName} bg-v2-blue`}>
          <PrismicNextImage
            className={`h-full w-full object-cover opacity-anim rounded-[5px]`}
            field={data[A].image}
