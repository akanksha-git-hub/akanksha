...
export default function ResourcesCardItemA({ item }) {
  ...
  return (
    <div className="grid xl:grid-cols-[minmax(200px,320px)_1fr_1fr] gap-y-6 xl:gap-y-0 xl:gap-x-8 pb-2 mt-8 border-b border-[#A3A19A] last:border-none">
  {/* Column 1 - Date */}
  <div className="font-ambit-regular flex flex-col justify-start  ">
    <RichText
  ...
  <div className="font-ambit-regular space-y-2 flex flex-col justify-start">
    <RichText
