...
export default function ResourcesCardItemA({ item }) {
  ...
  return (
    <div className="grid grid-cols-1 gap-y-6 xl:grid-cols-[minmax(200px,320px)_1fr_1fr] xl:gap-y-0 xl:gap-x-8 pb-2 mt-8 border-b border-[#A3A19A] last:border-none">
