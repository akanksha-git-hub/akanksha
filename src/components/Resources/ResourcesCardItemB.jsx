...
export default function ResourcesCardItemB({ item }) {
  ...
  return (
    <div className="grid space-y-6 xl:space-y-0 xl:grid-cols-3 xl:gap-12 3xl:gap-0 xl:flex  xl:justify-between xl:items-start pb-12 border-b border-[#A3A19A] last:border-none">
