    ...
    <>
      {data.map((item, i) => {
        ...
        return (
          <div
            key={i}
            className="grid space-y-6 xl:space-y-0 xl:grid-cols-3 xl:gap-12 3xl:gap-0 xl:place-content-between pb-12 border-b border-[#A3A19A] last:border-none"
          >
            <div className="font-ambit-regular">
              <RichText
                ...
                text={day}
              />
              <RichText className="text-deep-green text-5xl" text={monthYear} />
            </div>
