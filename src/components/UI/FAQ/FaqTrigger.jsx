export default function FaqItem({ answer, question, onClick, index, checkIndex }) {
  ...
  return (
    <li className="border-b border-[#D2D2D2] pb-6">
        <p onClick={onClick} className="text-black text-xl font-ambit-regular flex items-center justify-between cursor-pointer transition-all xl:hover:opacity-75 active:opacity-75">
            {question} 
        ...
        >
            <span className="text-black mt-4 flex text-base leading-6 w-[80%] overflow-hidden font-inter">
                {answer}
            </span>
        </p>
    </li>
