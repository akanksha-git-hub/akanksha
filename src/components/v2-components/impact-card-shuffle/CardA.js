export default function CardA({item}) {
    ...
    return (
        ...
        <div className="flex flex-col md:flex-row  h-full w-full">
            {/* Section 1 */}
            <div className="w-full md:w-[50%] p-12 flex flex-col justify-between">
                {/* Top Section */}
                <div>
                    <h1 className="text-2xl md:text-5xl lg:text-8xl text-black font-ambit-regular">94%</h1>
            ...
            <div className="w-full md:w-[50%] flex flex-col justify-end ">
                <div className="relative h-36 md:h-48 w-full flex justify-center items-end space-x-4">
                    {/* First Chart */}
                    <div className="bg-[#FBDA1D] w-[20%] h-[120%] md:w-[120px] md:h-[180%] "></div>
                    {/* Second Chart */}
                    <div className="bg-[#55BBD3] w-[20%] h-[50%] md:w-[120px] md:h-[70%]"></div>
                </div>
            </div>
        </div>
    </div>
