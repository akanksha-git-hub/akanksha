...
export default function HorizontalScrollCardC({ item }) {
  ...
  return (
    <div className="flex flex-col lg:flex-row bg-[#F6AC27] rounded-lg overflow-hidden w-full max-w-[1500px] md:p-6 h-[500px]  md:h-full md:max-h-[700px] mx-auto">
      {/* Left Section */}
      ...
      <div className="w-full lg:w-[40%] h-full flex flex-col items-center justify-center px-8 lg:px-0">
        {item.data.year_performance.map((performance, index) => {
          const bgColors = ["#4BCFEE", "#FBDA1D", "#FFFFFF"];
