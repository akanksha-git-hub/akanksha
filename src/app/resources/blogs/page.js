    ...
    <main className={`${maxwidth} universal-padding `}>
      <div className="flex flex-row justify-center items-center  ">
        ...
        <PrismicNextImage
          ...
          alt="Left Image"
          className="hidden md:block md:w-60 xl:translate-x-44 " // Adjust size as needed
        />
        <div className="flex flex-col items-center text-black">
          <RichText
            text={page.data.title}
            className={` font-ambit-regular text-7xl md:w-[12ch] text-left md:text-center  pt-6`}
          />
          <RichText
        ...
        <PrismicNextImage
          ...
          alt="Right Image"
          className="hidden md:block md:w-40 xl:-translate-x-44 "
        />
      </div>
